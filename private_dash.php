...
// 🔹 Nouveau : stats détaillées sur les billets (total_tickets, etc.)
$reservationStats = $statsManager->getReservationStats($userId);
?>
...
<div class="container py-4">
    ...
    <div class="private-card">
        ...
        <div class="quick-actions">
            ...
            <a href="Explorer.php" class="action-btn">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    stats.forEach(stat => {
        ...
        if (isNaN(finalValue)) return; // éviter NaN pour "4.7/5" etc.
        let currentValue = 0;
