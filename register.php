...
<head>
    ...
    <title>Inscription - MuseoLink</title>
     ...
     <div class="auth-container">
        <div class="auth-card wide" data-aos="zoom-in" data-aos-duration="800">
            ...
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Créez votre compte MuseoLink</p>
            </div>
            ...
            <form method="POST" id="registerForm">
                ...
                <div class="form-group">
                    <label class="form-label" for="login"><i class="fas fa-user-tag me-1"></i>Login (pseudo)</label>
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label class="form-label" for="nom"><i class="fas fa-user me-1"></i>Nom</label>
                        <div class="input-group">
                            <i class="fas fa-user"></i>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="prenom"><i class="fas fa-user me-1"></i>Prénom</label>
                        <div class="input-group">
                            <i class="fas fa-user"></i>
                ...
                <div class="form-group">
                    <label class="form-label" for="password"><i class="fas fa-lock me-1"></i>Mot de passe</label>
                    <div class="input-group">
                ...
                <div class="form-group">
                    <label class="form-label" for="confirm_password"><i class="fas fa-lock me-1"></i>Confirmer</label>
                    <div class="input-group">
                        <i class="fas fa-lock"></i>
