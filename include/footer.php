                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        ...
                        <form class="newsletter-form" onsubmit="return false;">
                            <label for="footer-newsletter-email" class="visually-hidden">Email pour la newsletter</label>
                            <input type="email" id="footer-newsletter-email" placeholder="Votre email" class="newsletter-input" required>
