                ...
                <?php if ($isLoggedIn): ?>
                    ...
                    <form method="POST" id="reservationForm">
                        ...
                        <div class="form-group">
                            <label class="form-label mb-3" for="museumSelect">
                        ...
                        <div class="date-time-grid">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control" name="date" id="visit_date" required 
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="time" id="visit_time" required>
                ...
                form.addEventListener('submit', async function(e) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            alert('Erreur serveur: La reponse n\'est pas au format JSON. Verifiez la console.');
                        ...
                        alert('Erreur de connexion. Veuillez verifier la console pour plus de details.');
                        submitBtn.innerHTML = originalText;
                        submitBtn.disabled = false;
                    }
                });
