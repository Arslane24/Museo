...
<section class="explorer-hero" aria-label="Section de recherche de musées">
...
<section class="harvard-section py-5">
    <div class="container">
        <div class="text-center mb-5" data-aos="fade-up">
            ...
            <h2 class="section-title mt-3">Collections Harvard</h2>
            <p class="section-subtitle">Découvrez les trésors des musées de Harvard University</p>
        </div>
