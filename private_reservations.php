...
<div class="container py-4">
    ...
    <div class="private-card">
        ...
        <div class="filter-tabs">
            <a href="?filter=all" class="filter-tab <?= $filter === 'all' ? 'active' : '' ?>" style="color: white !important;">
                <span>Toutes</span>
                <span class="filter-count"><?= $stats['all'] ?></span>
            </a>
            <a href="?filter=confirmed" class="filter-tab <?= $filter === 'confirmed' ? 'active' : '' ?>" style="color: white !important;">
                <span>Confirmées</span>
                <span class="filter-count"><?= $stats['confirmed'] ?></span>
            </a>
            <a href="?filter=pending" class="filter-tab <?= $filter === 'pending' ? 'active' : '' ?>" style="color: white !important;">
                <span>En attente</span>
                <span class="filter-count"><?= $stats['pending'] ?></span>
            </a>
            <a href="?filter=completed" class="filter-tab <?= $filter === 'completed' ? 'active' : '' ?>" style="color: white !important;">
                <span>Complétées</span>
                <span class="filter-count"><?= $stats['completed'] ?></span>
            </a>
            <a href="?filter=cancelled" class="filter-tab <?= $filter === 'cancelled' ? 'active' : '' ?>" style="color: white !important;">
                <span>Annulées</span>
...
async function cancelReservation(reservationId, museumName) {
    ...
    try {
        ...
        if (data.success) {
            ...
            alert('Erreur : ' + (data.error || 'Impossible d\'annuler la reservation'));
        }
    } catch (error) {
