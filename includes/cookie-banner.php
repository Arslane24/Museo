...
<div id="cookieConsent" style="position: fixed; bottom: 0; left: 0; right: 0; background: linear-gradient(135deg, #1a4d7a 0%, #0f172a 100%); padding: 1.5rem 0; box-shadow: 0 -10px 40px rgba(0,0,0,0.3); z-index: 9999; border-top: 3px solid #d4af37;">
    <div class="container">
        <form method="POST" action="">
            <div class="row align-items-center">
                <div class="col-lg-8 mb-3 mb-lg-0">
                    <div style="display: flex; align-items: center; gap: 1rem;">
                        <div style="width: 50px; height: 50px; background: linear-gradient(135deg, #d4af37, #f0c748); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                ...
                <div class="col-lg-4">
                    <div style="display: flex; gap: 0.75rem; justify-content: lg-end; flex-wrap: wrap;">
                        <button type="submit" name="accept_cookies" style="background: linear-gradient(135deg, #d4af37, #f0c748); color: #0f172a; border: none; padding: 0.75rem 1.8rem; border-radius: 50px; font-weight: 700; cursor: pointer; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(212, 175, 55, 0.3); font-size: 0.95rem;">
