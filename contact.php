...
<section class="hero-section contact-hero" aria-label="Section contact">
    <div class="hero-content">
        <div class="hero-text-wrapper text-center">
            <h1 class="hero-title animate-up">Contactez-Nous</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
                        ...
                        <form method="POST" action="" class="contact-form">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control form-control-lg" id="message" name="message" 
                                          rows="5" placeholder="Votre message..." required></textarea>
                            </div>
                            
                            <div class="d-grid">
                                <button type="submit" class="btn btn-lg py-3 btn-contact-submit">
            ...
            <div class="col-lg-4 mt-4 mt-lg-0">
                <div class="card info-card shadow border-0">
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div class="d-flex gap-2 social-buttons">
                ...
                <div class="card help-card shadow border-0">
                    <div class="card-body">
